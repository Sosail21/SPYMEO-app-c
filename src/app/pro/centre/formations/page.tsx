// src/app/pro/formations/page.tsx
"use client";
...
// ———————————————————————————————————————————————————————————————————————————
// Data hook : tente un fetch API, sinon mock local (pour dev)
// ———————————————————————————————————————————————————————————————————————————
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // 🔧 MOCK local si l'API n'est pas encore branchée
        if (!canceled) {
          setData(MOCK_TRAININGS);
        }
      } finally {
    ...
    <main className="container-spy space-y-4 compact-sections">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div>
            ...
            <p className="text-slate-600">
              Créez, publiez et suivez vos programmes et sessions (inscriptions, capacités, statut).
            </p>
          </div>
          <div className="flex flex-wrap gap-2">
            <Link href="/pro/formations/nouvelle" className="btn">
              + Nouvelle formation
            </Link>
            <Link href="/pro/academie" className="btn btn-outline">
              Aller à l’Académie
            </Link>
          </div>
        </div>
      ...
      <section className="section">
        {loading ? (
          ...
          <EmptyState onCreateHref="/pro/formations/nouvelle" />
        ) : (
                  ...
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        {full && (
                          <span className="pill bg-amber-100 text-amber-700" title="Capacité atteinte">
                            Complet
                          </span>
                        )}
                      </div>
                      <div className="mt-1 flex flex-wrap items-center gap-3 text-sm text-slate-600">
                        <span className="inline-flex items-center gap-1">
                          <span>🎥</span> {labelModality(t.modality)}
                        </span>
                        {t.nextSession && (
                          <span className="inline-flex items-center gap-1">
                            <span>🗓</span> Prochaine : {fmtDate(t.nextSession)}
                          </span>
                        )}
                        {typeof enrolled === "number" && hasCap && (
                          <span className="inline-flex items-center gap-1">
                            <span>👥</span> {enrolled}/{t.seats} inscrits
                          </span>
                        )}
                        {typeof t.price === "number" && (
                          <span className="inline-flex items-center gap-1">
                            <span>💶</span> {t.price.toFixed(0)} € TTC
                          </span>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      <Link
                        ...
                        title="Voir la fiche formation et ses sessions"
                      >
                        Détails & sessions
                      </Link>
                      <Link
                        href={`/pro/formations/${t.slug}/sessions/nouvelle`}
                        className="pill pill-ghost"
                        title="Créer une session pour cette formation"
                      >
                        + Créer une session
                      </Link>
                      <Link href={`/formations/${t.slug}`} className="pill pill-muted" target="_blank">
                        Aperçu public
                      </Link>
                      {t.status !== "ARCHIVED" ? (
                        <button
                          ...
                          onClick={() => alert("Archivage (à implémenter)")}
                        >
                          Archiver
                        </button>
                      ) : (
      ...
      <section className="section">
        <div className="soft-card p-3 flex items-center justify-between">
          <span className="text-sm text-slate-600">
            {total} formation{total > 1 ? "s" : ""} • page {page}/{maxPage}
          </span>
  ...
  return (
    <div className="soft-card p-8 text-center">
      ...
      <p className="text-slate-600 mt-1">
        Créez votre première formation en ligne, ajoutez vos sessions, puis publiez-la.
      </p>
      <div className="mt-4">
        <Link href={onCreateHref} className="btn">
          + Nouvelle formation
        </Link>
      </div>
    </div>
...
// ———————————————————————————————————————————————————————————————————————————
// MOCK (supprime quand l’API est prête)
// ———————————————————————————————————————————————————————————————————————————
const MOCK_TRAININGS: Training[] = [
  {
    id: "t1",
    title: "Réflexologie plantaire — module d’initiation",
    slug: "reflexologie-plantaire-initiation",
    modality: "ONLINE",
  ...
  {
    id: "t2",
    title: "Kobido : fondamentaux & posture",
    slug: "kobido-fondamentaux-posture",
    modality: "HYBRID",
  ...
  {
    id: "t3",
    title: "Éthique & cadre pro en cabinet libéral",
    slug: "ethique-cadre-pro-cabinet-liberal",
    modality: "ONLINE",
    nextSession: "2025-12-02",
    seats: 100,
    enrolled: 76,
    price: 0,
    status: "PUBLISHED",
  ...
  {
    id: "t4",
    title: "Aromathérapie avancée — cas pratiques",
    slug: "aromatherapie-avancee-cas-pratiques",
    modality: "ONLINE",
    seats: 50,
    enrolled: 50,
    price: 240,
