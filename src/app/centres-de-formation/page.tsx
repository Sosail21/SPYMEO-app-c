...
const MOCK: UniverseItem[] = [
  { id: "centre-horizon", name: "Centre Horizon", title: "Naturopathie — certifiant", city: "Dijon", distanceKm: 0, tags: ["Prochaine session : Oct"], affinity: 90 },
  { id: "academie-bien-etre", name: "Académie Bien-Être", title: "Sophrologie — intensif", city: "Beaune", distanceKm: 15, tags: ["Week-end"], affinity: 86 },
  { id: "institut-soma", name: "Institut Soma", title: "Réflexologie — pro", city: "Quetigny", distanceKm: 6, tags: ["Eligible CPF (exemple)"], affinity: 85 },
];
