    ...
    <div className="h-full flex flex-col">
      ...
      <div className="p-4 grid gap-3 text-sm">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-[#e6eef2] grid place-content-center text-base">{other?.avatar || "👤"}</div>
          <div>
        ...
        <div className="grid gap-2">
          <Link className="pill pill-ghost text-center" href={other ? `/pro/messages?to=${other.id}` : "#"}>Ouvrir dans SPYM’Com</Link>
          <a className="pill pill-ghost text-center" href={other ? `mailto:test@spymeo.test` : "#"}>Envoyer un e‑mail</a>
        </div>
