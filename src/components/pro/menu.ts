...
export function normalizeRole(role?: string) {
  ...
  return r; // garde tel quel si déjà bon
}

export const MENUS: RoleMenus = {
  // Items communs, visibles pour TOUS les pros connectés
  common: [
  ...
  // Spécifique CENTRE DE FORMATION
  center: [
...
export function itemsForRole(role?: string) {
  const r = normalizeRole(role); // ⟵ la clé
